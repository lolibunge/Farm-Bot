  ...
  try {
    ...
    res.status(200).json({
      ...
      horse_groups: filteredHorseGroupRows.map((row) => ({
        ...
        current_locations: paddocksModuleEnabled ? row.current_locations : [],
        current_location_count: paddocksModuleEnabled ? row.current_location_count : 0,
        ...
        located_member_count: row.located_member_count,
        unassigned_member_count: row.unassigned_member_count,
        unassigned_members: row.unassigned_members,
      ...
      paddock_occupancy: filteredPaddockOccupancyRows.map((row) => ({
        ...
        active_group_names: row.active_group_names,
        active_group_count: row.active_group_count,
        ungrouped_horse_count: row.ungrouped_horse_count,
